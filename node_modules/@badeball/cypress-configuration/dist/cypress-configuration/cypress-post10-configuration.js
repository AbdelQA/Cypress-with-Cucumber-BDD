...
function resolvePost10Configuration(options) {
    ...
    const configOrigin = Object.assign({}, ...Object.entries((_b = parseConfigurationFile(cypressConfigPath, (_a = options.parseDangerously) !== null && _a !== void 0 ? _a : false)[testingType]) !== null && _b !== void 0 ? _b : {}).map((entry) => validateConfigurationEntry(...entry)));
    const defaults = testingType === "e2e"
        ? {
    ...
    const configuration = Object.assign(Object.assign({ testingType, projectRoot: (0, helpers_1.resolveProjectPath)(options), env: {} }, defaults), configOrigin, envOrigin, cliOrigin);
...
function parseConfigurationFileDangerously(configFile) {
    ...
    return (_a = result.default) !== null && _a !== void 0 ? _a : result;
}
