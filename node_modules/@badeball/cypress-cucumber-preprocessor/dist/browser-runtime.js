...
function taskSpecEnvelopes(messages) {
    cy.task(cypress_task_definitions_1.TASK_SPEC_ENVELOPES, { messages }, {
        log: false,
    });
}
function taskTestCaseStarted(testCaseStarted) {
    cy.task(cypress_task_definitions_1.TASK_TEST_CASE_STARTED, testCaseStarted, {
        log: false,
    });
}
function taskTestCaseFinished(testCasefinished) {
    cy.task(cypress_task_definitions_1.TASK_TEST_CASE_FINISHED, testCasefinished, {
        log: false,
    });
}
function taskTestStepStarted(testStepStarted) {
    cy.task(cypress_task_definitions_1.TASK_TEST_STEP_STARTED, testStepStarted, {
        log: false,
    });
}
function taskTestStepFinished(testStepfinished) {
...
function afterEachHandler(context) {
    ...
    if (context.messagesEnabled) {
        ...
        const currentRetry = (0, assertions_1.assertAndReturn)((_q = this.currentTest) === null || _q === void 0 ? void 0 : _q._currentRetry, "Expected to find an attribute _currentRetry");
        const retries = (0, assertions_1.assertAndReturn)((_r = this.currentTest) === null || _r === void 0 ? void 0 : _r._retries, "Expected to find an attribute _retries");
        const willBeRetried = ((_s = this.currentTest) === null || _s === void 0 ? void 0 : _s.state) === "failed" ? currentRetry < retries : false;
...
function createTests(registry, seed, source, gherkinDocument, pickles, messagesEnabled, omitFiltered, stepDefinitionHints) {
